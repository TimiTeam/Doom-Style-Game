...
SRCS	:= sdl_worker.c sdl_create.c sdl_exit.c sdl_texture.c img_loader.c ttf_worker.c sector_worker.c test_main.c make_sectors.c texture.c timer.c pixel_worker.c
